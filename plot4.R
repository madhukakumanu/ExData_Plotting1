...
# Initialize mfrow parameter
par(mfrow = c(2,2))

#Command to draw first graph in the plot
plot(hh.filteredDS$dateTime,hh.filteredDS$Global_active_power, type="l", ylab="Global Active Power", xlab="")

#Command to draw second graph in the plot
plot(hh.filteredDS$dateTime,hh.filteredDS$Voltage, type="l", ylab="Voltage", xlab="datetime")

#Command to draw third graph in the plot
plot(hh.filteredDS$dateTime,hh.filteredDS$Sub_metering_1, type="l", ylab="Energy sub metering", xlab="")
lines(hh.filteredDS$dateTime, hh.filteredDS$Sub_metering_2, col = 'red')
lines(hh.filteredDS$dateTime, hh.filteredDS$Sub_metering_3, col = 'blue')
legend("topright",legend = c("sub_metering_1","sub_metering_2","sub_metering_3"),col=c("black","red","blue"),lty=1:2)

#Command to draw fourth graph in the plot
plot(hh.filteredDS$dateTime,hh.filteredDS$Global_reactive_power, type="l", ylab="Global_reactive_power", xlab="datetime")
