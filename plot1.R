...
hh.filteredDS$dateTime = paste(hh.filteredDS$Date, hh.filteredDS$Time)

# Below command plots Histogram graph on the screen
png("plot1.png", width = 480,height=480)
hist(as.numeric(hh.filteredDS$Global_active_power),main="Global Active Power",xlab="Global Active Power (kilowatts)",col="red")
dev.off()
